    ...
    <StyledWrapper>
      ...
      <div className="actions">
        <Button
          ...
          variant="outline"
          className="gap-2 rounded-xl border-2 hover:bg-orange-50 dark:hover:bg-orange-950"
        >
        ...
        <Button
          onClick={() => setLocation('/')}
          className="gap-2 bg-gradient-to-r from-orange-500 to-amber-500 hover:from-orange-600 hover:to-amber-600 rounded-xl shadow-lg shadow-orange-500/25"
        >
...
const StyledWrapper = styled.div`
  ...
  min-height: 100vh;
  background: linear-gradient(135deg, #fef3e2 0%, #fde8d0 50%, #fce0c2 100%);
  padding: 2rem;
  gap: 2rem;
